...
<div class="collapse" id="collapsePages" aria-labelledby="heading{{ $id }}" data-bs-parent="#{{ $parentId }}">
    <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordion{{ $id }}Nested">
